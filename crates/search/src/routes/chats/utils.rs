...
use search_types::milli::index::ChatConfig;
use search_types::milli::prompt::{Prompt, PromptData};
use search_types::milli::update::new::document::DocumentFromDb;
use search_types::milli::{
    DocumentId, FieldIdMapWithMetadata, GlobalFieldsIdsMap, MetadataBuilder,
};
use search_types::{Document, Index};
use serde::Serialize;
