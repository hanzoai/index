...
async fn error_api_key_bad_content_types() {
    ...
    assert_eq!(response["link"], "https://docs.hanzo.ai/docs/errors#invalid_content_type");
...
async fn error_api_key_missing_content_types() {
    ...
    assert_eq!(response["type"], "invalid_request");
    assert_eq!(response["link"], "https://docs.hanzo.ai/docs/errors#missing_content_type");
...
async fn error_api_key_empty_payload() {
    ...
    assert_eq!(response["link"], json!("https://docs.hanzo.ai/docs/errors#missing_payload"));
...
async fn error_api_key_malformed_payload() {
    ...
    assert_eq!(response["type"], json!("invalid_request"));
    assert_eq!(response["link"], json!("https://docs.hanzo.ai/docs/errors#malformed_payload"));
    assert_eq!(
        response["message"],
        json!(
