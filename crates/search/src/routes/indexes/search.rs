...
- A GET route: the usage of this route is discouraged, unless you have good reason to do otherwise (specific caching abilities for example)",
            external_docs(
                url = "https://docs.hanzo.ai/docs/search",
...
pub struct SearchQueryGet {
    ...
    ///
    /// The value cannot exceed the index [maxTotalHits](https://docs.hanzo.ai/docs/search) setting.
    ...
    /// Name of the embedder for [hybrid search](https://docs.hanzo.ai/docs/search), which combines keyword and semantic search.
    ///
    ...
    /// For [personalized search](https://docs.hanzo.ai/docs/search): a string describing the user (e.g. preferences or behavior).
    ///
