...
async fn invalid_federated_search() {
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[duration]", ".requestUid" => "[uuid]"}), @r###"
    {
      ...
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_query_show_performance_details"
    }
    "###);
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[duration]", ".requestUid" => "[uuid]"}), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_show_performance_details"
    }
    "###);
}
