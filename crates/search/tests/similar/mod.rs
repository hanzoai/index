...
async fn ranking_score_threshold() {
    ...
    index
        .similar(
            ...
            |response, code| {
                snapshot!(code, @"200 OK");
                search_snap::snapshot!(search_snap::json_string!(response["estimatedTotalHits"]), @"4");
                snapshot!(json_string!(response["hits"]), @r###"
                [
                  {
                    "title": "Escape Room",
    ...
    index
        .similar(
            ...
            |response, code| {
                snapshot!(code, @"200 OK");
                search_snap::snapshot!(search_snap::json_string!(response["estimatedTotalHits"]), @"3");
                snapshot!(json_string!(response["hits"]), @r###"
                [
                  {
                    "title": "Escape Room",
    ...
    index
        .similar(
            ...
            |response, code| {
                snapshot!(code, @"200 OK");
                search_snap::snapshot!(search_snap::json_string!(response["estimatedTotalHits"]), @"2");
                snapshot!(json_string!(response["hits"]), @r###"
                [
                  {
                    "title": "Escape Room",
    ...
    index
        .similar(
            ...
            |response, code| {
                snapshot!(code, @"200 OK");
                search_snap::snapshot!(search_snap::json_string!(response["estimatedTotalHits"]), @"1");
                snapshot!(json_string!(response["hits"]), @r###"
                [
                  {
                    "title": "Escape Room",
