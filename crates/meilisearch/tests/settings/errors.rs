...
async fn settings_bad_displayed_attributes() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "link": "https://docs.hanzo.ai/errors#invalid_settings_displayed_attributes"
    }
    "###);
...
async fn settings_bad_searchable_attributes() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_searchable_attributes"
    }
    "###);
...
async fn settings_bad_filterable_attributes() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_filterable_attributes"
    }
    "###);
...
async fn settings_bad_sortable_attributes() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_sortable_attributes"
    }
    "###);
...
async fn settings_bad_stop_words() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_stop_words"
    }
    "###);
...
async fn settings_bad_synonyms() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_synonyms"
    }
    "###);
...
async fn settings_bad_distinct_attribute() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_distinct_attribute"
    }
    "###);
...
async fn settings_bad_typo_tolerance() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_typo_tolerance"
    }
    "###);
...
async fn settings_bad_faceting() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_faceting"
    }
    "###);
...
async fn settings_bad_pagination() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_pagination"
    }
    "###);
...
async fn settings_bad_search_cutoff_ms() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_settings_search_cutoff_ms"
    }
    "###);
