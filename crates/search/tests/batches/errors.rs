...
async fn batch_bad_uids() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_uids"
    }
    "#);
}
...
async fn batch_bad_canceled_by() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_canceled_by"
    }
    "#);
}
...
async fn batch_bad_types() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_types"
    }
    "###);
}
...
async fn batch_bad_statuses() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_statuses"
    }
    "#);
}
...
async fn batch_bad_limit() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_limit"
    }
    "#);
}
...
async fn batch_bad_from() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_from"
    }
    "#);
}
...
async fn bask_bad_reverse() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_reverse"
    }
    "###);
...
async fn batch_bad_after_enqueued_at() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_after_enqueued_at"
    }
    "#);
}
...
async fn batch_bad_before_enqueued_at() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_before_enqueued_at"
    }
    "#);
}
...
async fn batch_bad_after_started_at() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_after_started_at"
    }
    "#);
}
...
async fn batch_bad_before_started_at() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_before_started_at"
    }
    "#);
}
...
async fn batch_bad_after_finished_at() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_after_finished_at"
    }
    "#);
}
...
async fn batch_bad_before_finished_at() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_task_before_finished_at"
    }
    "#);
}
