...
pub(crate) mod test {
    ...
    fn compat_v4_v5() {
        ...
        search_snap::snapshot_hash!(search_snap::json_string!(tasks), @"ed9a30cded4c046ef46f7cff7450347e");
        ...
        search_snap::snapshot_hash!(search_snap::json_string!(keys, { "[].uid" => "[uuid]" }), @"1384361d734fd77c23804c9696228660");
