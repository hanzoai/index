...
async fn version_too_old() {
    ...
    let major = search_types::versioning::VERSION_MAJOR;
    let minor = search_types::versioning::VERSION_MINOR;
    let patch = search_types::versioning::VERSION_PATCH;
...
async fn version_requires_downgrade() {
    ...
    let major = search_types::versioning::VERSION_MAJOR;
    let minor = search_types::versioning::VERSION_MINOR;
    let mut patch = search_types::versioning::VERSION_PATCH;
