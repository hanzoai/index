...
async fn task_bad_canceled_by() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_canceled_by"
    }
    "###);
...
async fn task_bad_types() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_types"
    }
    "###);
...
async fn task_bad_statuses() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_statuses"
    }
    "###);
...
async fn task_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_limit"
    }
    "###);
...
async fn task_bad_reverse() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_reverse"
    }
    "###);
...
async fn task_bad_after_enqueued_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_after_enqueued_at"
    }
    "###);
...
async fn task_bad_before_enqueued_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_before_enqueued_at"
    }
    "###);
...
async fn task_bad_after_started_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_after_started_at"
    }
    "###);
...
async fn task_bad_after_finished_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_after_finished_at"
    }
    "###);
...
async fn task_bad_before_finished_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_task_before_finished_at"
    }
    "###);
