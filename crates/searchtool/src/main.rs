...
use search_types::heed::types::{Bytes, SerdeJson, Str};
...
use search_types::milli::documents::{obkv_to_object, DocumentsBatchReader};
...
use search_types::milli::{obkv_to_json, CreateOrOpen, BEU32};
use search_types::tasks::{Status, Task};
use search_types::versioning::{get_version, parse_version};
                    ...
                    'inject_vectors: {
                        ...
                        let Object(vectors) = vectors else {
                            return Err(search_types::milli::Error::UserError(
                                search_types::milli::UserError::InvalidVectorsMapType {
                                    document_id: {
