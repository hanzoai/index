...
async fn simple_search_missing_index_uid() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#missing_index_uid"
    }
    "###);
}
...
async fn federation_sort_same_indexes_same_criterion_opposite_direction() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_query_ranking_rules"
    }
    "###);
...
async fn federation_invalid_weight() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_weight"
    }
    "###);
}
...
async fn federation_federated_contains_pagination() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_query_pagination"
    }
    "###);
...
async fn federation_federated_contains_facets() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_query_facets"
    }
    "###);
}
...
async fn federation_contains_two_distincts() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_distinct"
    }
    "###);
}
...
async fn federation_non_faceted_for_an_index() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_facets"
    }
    "###);
...
async fn federation_non_federated_contains_federation_option() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_federation_options"
    }
    "###);
}
...
async fn federation_inconsistent_merge_order() {
  ...
  .await;
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_multi_search_facet_order"
    }
    "###);
