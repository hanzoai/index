...
macro_rules! make_setting_routes {
    ($({route: $route:literal, update_verb: $update_verb:ident, value_type: $type:ty, err_type: $err_ty:ty, attr: $attr:ident, camelcase_attr: $camelcase_attr:literal, analytics: $analytics:ident},)*) => {
        const _: fn(&search_types::settings::Settings<search_types::settings::Unchecked>) = |s| {
            // This pattern match will fail at compile time if any field in Settings is not listed in the macro
            match *s {
                search_types::settings::Settings { $($attr: _,)* _kind: _ } => {}
            }
        };
        $(
...
macro_rules! make_setting_route {
    ($route:literal, $update_verb:ident, $type:ty, $err_type:ty, $attr:ident, $camelcase_attr:literal, $analytics:ident) => {
        pub mod $attr {
            ...
            use search_types::index_uid::IndexUid;
            use search_types::milli::update::Setting;
            use search_types::settings::{settings, Settings};
            use tracing::debug;
            use $crate::analytics::Analytics;
            use $crate::extractors::authentication::policies::*;
            use $crate::extractors::authentication::GuardedData;
            ...
            pub async fn get(
                ...
                let settings = settings(&index, &rtxn, search_types::settings::SecretPolicy::HideSecrets)?;
...
make_setting_routes!(
    {
        ...
        update_verb: put,
        value_type: Vec<search_types::milli::FilterableAttributesRule>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsFilterableAttributes,
        >,
    ...
    },
    {
        ...
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsSortableAttributes,
        >,
    ...
    },
    {
        ...
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsDisplayedAttributes,
        >,
    ...
    },
    {
        ...
        update_verb: patch,
        value_type: search_types::settings::TypoSettings,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsTypoTolerance,
        >,
        attr: typo_tolerance,
    ...
    },
    {
        ...
        value_type: Vec<String>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsSearchableAttributes,
        >,
    ...
    },
    {
        ...
        value_type: std::collections::BTreeSet<String>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsStopWords,
        >,
        attr: stop_words,
    ...
    },
    {
        ...
        value_type: std::collections::BTreeSet<String>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsNonSeparatorTokens,
        >,
    ...
    },
    {
        ...
        value_type: std::collections::BTreeSet<String>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsSeparatorTokens,
        >,
    ...
    },
    {
        ...
        value_type: std::collections::BTreeSet<String>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsDictionary,
        >,
        attr: dictionary,
    ...
    },
    {
        ...
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsSynonyms,
        >,
        attr: synonyms,
    ...
    },
    {
        ...
        value_type: String,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsDistinctAttribute,
        >,
    ...
    },
    {
        ...
        update_verb: put,
        value_type: search_types::settings::ProximityPrecisionView,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsProximityPrecision,
        >,
    ...
    },
    {
        ...
        update_verb: put,
        value_type: Vec<search_types::locales::LocalizedAttributesRuleView>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsLocalizedAttributes,
        >,
    ...
    },
    {
        route: "/ranking-rules",
        update_verb: put,
        value_type: Vec<search_types::settings::RankingRuleView>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsRankingRules,
        >,
        attr: ranking_rules,
    ...
    },
    {
        route: "/faceting",
        update_verb: patch,
        value_type: search_types::settings::FacetingSettings,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsFaceting,
        >,
        attr: faceting,
    ...
    },
    {
        route: "/pagination",
        update_verb: patch,
        value_type: search_types::settings::PaginationSettings,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsPagination,
        >,
        attr: pagination,
    ...
    },
    {
        ...
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsEmbedders,
        >,
        attr: embedders,
    ...
    },
    {
        ...
        value_type: u64,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsSearchCutoffMs,
        >,
    ...
    },
    {
        ...
        value_type: bool,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsFacetSearch,
        >,
        attr: facet_search,
    ...
    },
    {
        route: "/prefix-search",
        update_verb: put,
        value_type: search_types::settings::PrefixSearchSettings,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsPrefixSearch,
        >,
        attr: prefix_search,
    ...
    },
    {
        ...
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsIndexChat,
        >,
        attr: chat,
        camelcase_attr: "chat",
    ...
    },
    {
        route: "/foreign-keys",
        update_verb: put,
        value_type: Vec<search_types::milli::ForeignKey>,
        err_type: search_types::deserr::DeserrJsonError<
            search_types::error::deserr_codes::InvalidSettingsForeignKeys,
        >,
        attr: foreign_keys,
...
fn validate_settings(
    ...
    use search_types::milli::update::Setting;
    use search_types::milli::vector::settings::EmbedderSource;
