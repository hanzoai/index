...
impl From<search_types::features::RuntimeTogglableFeatures> for RuntimeTogglableFeatures {
    fn from(value: search_types::features::RuntimeTogglableFeatures) -> Self {
        let search_types::features::RuntimeTogglableFeatures {
            metrics,
            logs_route,
...
async fn patch_features(
    ...
    let new_features = search_types::features::RuntimeTogglableFeatures {
