...
pub(crate) mod test {
    ...
    fn read_dump_v5() {
        ...
        search_snap::snapshot_hash!(search_snap::json_string!(tasks), @"e159863f0442b2e987ce37fbd57af76b");
        ...
        search_snap::snapshot_hash!(search_snap::json_string!(keys), @"091ddad754f3cc7cf1d03a477855e819");
