...
- [ ] This PR uses generative AI tooling and respect the [related policies](https://github.com/hanzoai/search/blob/main/CONTRIBUTING.md#use-of-generative-ai-tools)
