...
async fn add_valid_api_key() {
    ...
    search_snap::snapshot!(code, @"201 Created");
...
async fn add_valid_api_key_expired_at() {
    ...
    let (response, code) = server.add_api_key(content).await;
    search_snap::snapshot!(code, @"201 Created");
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]", ".uid" => "[ignored]", ".key" => "[ignored]" }), @r###"
    {
      "name": null,
      "description": "Indexing API key",
      "key": "[ignored]",
...
async fn error_add_api_key_no_header() {
    ...
    let (response, code) = server.add_api_key(content).await;
    search_snap::snapshot!(code, @"401 Unauthorized");
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
...
async fn error_add_api_key_bad_key() {
    ...
    let (response, code) = server.add_api_key(content).await;
    search_snap::snapshot!(code, @"403 Forbidden");
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
...
async fn error_add_api_key_missing_parameter() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "link": "https://docs.hanzo.ai/docs/errors#missing_api_key_indexes"
    }
    "###);
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#missing_api_key_actions"
    }
    "###);
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]", ".uid" => "[ignored]", ".key" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#missing_api_key_expires_at"
    }
    "###);
}
...
async fn error_add_api_key_invalid_parameters_description() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_api_key_description"
    }
    "###);
}
...
async fn error_add_api_key_invalid_parameters_name() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_api_key_name"
    }
    "###);
}
...
async fn error_add_api_key_invalid_parameters_indexes() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_api_key_indexes"
    }
    "###);
}
...
async fn error_add_api_key_invalid_parameters_actions() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_api_key_actions"
    }
    "###);
...
async fn error_add_api_key_invalid_parameters_expires_at() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_api_key_expires_at"
    }
    "###);
}
...
async fn error_add_api_key_invalid_parameters_uid() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_api_key_uid"
    }
    "###);
    search_snap::snapshot!(code, @"400 Bad Request");
}
...
async fn error_add_api_key_parameters_uid_already_exist() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#api_key_already_exists"
    }
    "###);
    search_snap::snapshot!(code, @"409 Conflict");
}
...
async fn get_api_key() {
    ...
    "###);
    search_snap::snapshot!(code, @"200 OK");
    // get with key
...
async fn error_get_api_key_not_found() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#api_key_not_found"
    }
    "###);
    search_snap::snapshot!(code, @"404 Not Found");
}
...
async fn list_api_keys() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".results[].createdAt" => "[ignored]", ".results[].updatedAt" => "[ignored]", ".results[].uid" => "[ignored]", ".results[].key" => "[ignored]" }), @r#"
    {
      "results": [
        {
          "name": null,
...
async fn delete_api_key() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @"null");
    search_snap::snapshot!(code, @"204 No Content");

    // check if API key no longer exist.
    let (response, code) = server.get_api_key(&uid).await;
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]", ".message" => "[ignored]" }), @r###"
    {
      "message": "[ignored]",
      "code": "api_key_not_found",
      "type": "invalid_request",
...
async fn error_patch_api_key_indexes() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#immutable_api_key_indexes"
    }
    "###);
    search_snap::snapshot!(code, @"400 Bad Request");
}
...
async fn error_patch_api_key_actions() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#immutable_api_key_actions"
    }
    "###);
    search_snap::snapshot!(code, @"400 Bad Request");
}
...
async fn error_patch_api_key_expiration_date() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#immutable_api_key_expires_at"
    }
    "###);
    search_snap::snapshot!(code, @"400 Bad Request");
}
...
async fn error_access_api_key_routes_no_master_key_set() {
    ...
    search_snap::snapshot!(search_snap::json_string!(response, { ".createdAt" => "[ignored]", ".updatedAt" => "[ignored]" }), @r###"
    {
      ...
      "type": "auth",
      "link": "https://docs.hanzo.ai/docs/errors#missing_master_key"
    }
    "###);
    search_snap::snapshot!(code, @"401 Unauthorized");
