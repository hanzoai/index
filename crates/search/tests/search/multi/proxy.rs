...
#[actix_rt::test]
async fn sharding_not_supported() {
    let ms0 = Server::new().await;
    ...
    snapshot!(code, @"501 Not Implemented");
    snapshot!(json_string!(response), @r###"
    {
      "message": "Electing a `network.leader` is not supported by this distribution",
      "code": "feature_not_supported",
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#feature_not_supported"
    }
    "###);
}
