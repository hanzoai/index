...
async fn get_all_documents_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "link": "https://docs.hanzo.ai/docs/errors#invalid_document_offset"
    }
    "###);
...
async fn get_all_documents_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_document_limit"
    }
    "###);
...
async fn replace_documents_bad_csv_delimiter() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_document_csv_delimiter"
    }
    "###);
...
async fn delete_document_by_filter() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#missing_document_filter"
    }
    "###);
...
async fn fetch_document_by_filter() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_document_fields"
    }
    "###);
...
async fn retrieve_vectors() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_document_retrieve_vectors"
    }
    "###);
