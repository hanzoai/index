...
async fn swap_indexes_bad_indexes() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_swap_indexes"
    }
    "###);
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_swap_duplicate_index_found"
    }
    "###);
...
async fn swap_indexes_bad_rename() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_swap_rename"
    }
    "#);
}
