...
async fn similar_bad_id() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_similar_id"
    }
    "###);
}
...
async fn similar_bad_ranking_score_threshold() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_similar_ranking_score_threshold"
    }
    "###);
}
...
async fn similar_not_found_id() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#not_found_similar_id"
    }
    "###);
}
...
async fn similar_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_similar_offset"
    }
    "###);
...
async fn similar_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_similar_limit"
    }
    "###);
...
async fn similar_bad_filter() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_similar_filter"
    }
    "###);
...
async fn similar_bad_retrieve_vectors() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_similar_retrieve_vectors"
    }
    "###);
...
async fn similar_bad_embedder() {
    ...
    "type": "invalid_request",
    "link": "https://docs.hanzo.ai/docs/errors#invalid_similar_embedder"
    });
