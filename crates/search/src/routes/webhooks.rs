...
impl ErrorCode for WebhooksError {
    fn error_code(&self) -> search_types::error::Code {
        match self {
            MissingUrl(_) => search_types::error::Code::InvalidWebhookUrl,
            TooManyWebhooks => search_types::error::Code::InvalidWebhooks,
            TooManyHeaders(_) => search_types::error::Code::InvalidWebhookHeaders,
            ImmutableWebhook(_) => search_types::error::Code::ImmutableWebhook,
            WebhookNotFound(_) => search_types::error::Code::WebhookNotFound,
            InvalidHeaderName(_, _) => search_types::error::Code::InvalidWebhookHeaders,
            InvalidHeaderValue(_, _) => search_types::error::Code::InvalidWebhookHeaders,
            InvalidUrl(_, _) => search_types::error::Code::InvalidWebhookUrl,
            InvalidUuid(_) => search_types::error::Code::InvalidWebhookUuid,
        }
    }
}
