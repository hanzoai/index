...
async fn get_indexes_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "link": "https://docs.hanzo.ai/errors#invalid_index_offset"
    }
    "###);
}
...
async fn get_indexes_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_index_limit"
    }
    "###);
}
...
async fn create_index_bad_primary_key() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#invalid_index_primary_key"
    }
    "###);
}
...
async fn update_index_immutable_created_at() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#immutable_index_created_at"
    }
    "#);
}
...
async fn update_index_immutable_updated_at() {
    ...
    snapshot!(json_string!(response), @r#"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/errors#immutable_index_updated_at"
    }
    "#);
}
