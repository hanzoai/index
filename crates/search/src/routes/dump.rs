...
/// Create dump
///
/// Trigger a dump creation process. When complete, a dump file is written to the [dump directory](https://docs.hanzo.ai/docs/search). The directory is created if it does not exist.
#[routes::path(
