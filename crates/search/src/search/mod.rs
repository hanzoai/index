...
use search_auth::IndexSearchRules;
...
use search_types::milli::index::{self, EmbeddingsWithMetadata, SearchParameters};
use search_types::milli::progress::Progress;
use search_types::milli::score_details::{ScoreDetails, ScoringStrategy};
use search_types::milli::vector::parsed_vectors::ExplicitVectors;
use search_types::milli::vector::Embedder;
...
use search_types::{milli, Document};
    ...
    pub(crate) fn embedder(
        ...
        if let Some(vector_len) = vector_len {
            if vector_len != embedder.dimensions() {
                return Err(search_types::milli::Error::UserError(
                    search_types::milli::UserError::InvalidVectorDimensions {
