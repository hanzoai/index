...
async fn list_api_keys_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_api_key_offset"
    }
    "###);
}
...
async fn list_api_keys_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_api_key_limit"
    }
    "###);
}
...
async fn patch_api_keys_immutable_uid() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#immutable_api_key_uid"
    }
    "###);
}
...
async fn patch_api_keys_immutable_created_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#immutable_api_key_created_at"
    }
    "###);
}
...
async fn patch_api_keys_immutable_updated_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#immutable_api_key_updated_at"
    }
    "###);
}
