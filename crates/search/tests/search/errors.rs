...
async fn search_bad_q() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_q"
    }
    "###);
...
async fn search_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_offset"
    }
    "###);
...
async fn search_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_limit"
    }
    "###);
...
async fn search_bad_page() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_page"
    }
    "###);
...
async fn search_bad_hits_per_page() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_hits_per_page"
    }
    "###);
...
async fn search_bad_attributes_to_retrieve() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_attributes_to_retrieve"
    }
    "###);
...
async fn search_bad_retrieve_vectors() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_retrieve_vectors"
    }
    "###);
...
async fn search_bad_attributes_to_crop() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_attributes_to_crop"
    }
    "###);
...
async fn search_bad_crop_length() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_crop_length"
    }
    "###);
...
async fn search_bad_attributes_to_highlight() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_attributes_to_highlight"
    }
    "###);
...
async fn search_bad_sort() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_sort"
    }
    "###);
...
async fn search_bad_show_matches_position() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_show_matches_position"
    }
    "###);
...
async fn search_bad_facets() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_facets"
    }
    "###);
    // Can't make the `attributes_to_highlight` fail with a get search since it'll accept anything as an array of strings.
}
...
async fn search_bad_threshold() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_ranking_score_threshold"
    }
    "###);
}
...
async fn search_bad_highlight_pre_tag() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_highlight_pre_tag"
    }
    "###);
...
async fn search_bad_highlight_post_tag() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_highlight_post_tag"
    }
    "###);
...
async fn search_bad_crop_marker() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_crop_marker"
    }
    "###);
...
async fn search_bad_matching_strategy() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_matching_strategy"
    }
    "###);
    ...
    test_settings_documents_indexing_swapping_and_search(
        ...
        |response, code| {
            ...
            snapshot!(response, @r###"
            {
              ...
              "type": "invalid_request",
              "link": "https://docs.hanzo.ai/docs/errors#invalid_search_attributes_to_search_on"
            }
            "###);
        },
    )
...
async fn distinct_at_search_time() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_distinct"
    }
    "###);
...
async fn search_with_personalization_no_user_context() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.hanzo.ai/docs/errors#invalid_search_personalize"
    }
    "###);
}
